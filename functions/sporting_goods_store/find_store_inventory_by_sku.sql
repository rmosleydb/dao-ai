...
READS SQL DATA
COMMENT 'Retrieves detailed inventory information for sporting goods products by SKU at a specific store location. Use for store-level stock checks and availability.'
RETURN 
SELECT 
  inventory_id
  ,products.sku
